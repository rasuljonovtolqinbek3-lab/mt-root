  ...
  return (
    <PageWrapper>
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 text-center">
        ...
        <h1 className="text-3xl font-bold text-text-primary mb-3">Daily Challenge</h1>
        <p className="text-text-secondary max-w-lg mx-auto">Today's cybersecurity challenge.</p>
